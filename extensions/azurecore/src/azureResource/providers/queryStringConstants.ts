 ...
 */
export const cosmosMongoDbQuery = `where (type == "${azureResource.AzureResourceType.cosmosDbAccount}" and kind == "MongoDB") or type == "${azureResource.AzureResourceType.cosmosDbCluster}"`;
